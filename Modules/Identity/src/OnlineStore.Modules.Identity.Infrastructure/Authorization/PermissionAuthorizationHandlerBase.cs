        ...
        where TRequirement : PermissionAuthorizationRequirement
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, TRequirement requirement)
        {
            var limitedPermissionsClaim =
                context.User.FindFirstValue(Identity.Domain.Constants.SecurityConstants.Claims.LimitedPermissionsClaimType);
            ...
            if (limitedPermissionsClaim != null)
            {
                var limitedPermissions =
                    limitedPermissionsClaim.Split(Identity.Domain.Constants.SecurityConstants.Claims.PermissionClaimTypeDelimiter,
