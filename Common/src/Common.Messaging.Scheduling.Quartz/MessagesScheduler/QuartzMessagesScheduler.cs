...
namespace Common.Scheduling.Quartz.MessagesScheduler
{
    public class QuartzMessagesScheduler : IQuartzMessagesScheduler
    {
        ...
        public Task<string> Enqueue(ICommand command, string description = null)
        {
            var messageSerializedObject = SerializeObject(command, description);
            return Enqueue(messageSerializedObject, description);
        }

        public async Task<string> Enqueue(MessageSerializedObject messageSerializedObject, string description)
        {
