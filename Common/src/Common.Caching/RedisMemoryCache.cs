...
{
    public class ExtendedMemoryCache : IExtendedMemoryCache
    {
        ...
        public ExtendedMemoryCache(IMemoryCache memoryCache, IOptions<CachingOptions> options, ILogger<ExtendedMemoryCache> log)
        {
